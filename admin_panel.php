            ...
            <div id="body">
                <div class="header">
                    <div class="download">
                        <h1>Admin Panel</h1>
                        <ul>
                        <p><a href="notice_edit.php" >1. Edit Notice Board</a></p>
                        <p><a href="add_download.php" >2. Add Download</a></p>
                        <p><a href="add_photo.php">3. Add Photos</a></p>
                        <p><a href="localhost/phpmyadmin">4. MySQL</a></p>
                        </ul>
