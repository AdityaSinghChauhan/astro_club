            ...
            <div id="body">
                <div class="header">
					...
					<h1>Add Download</h1>
                                        ...
                                        <form action="add_download_exec.php" method="POST" enctype="multipart/form-data">
                                            <textarea name="about" cols="50" rows="7">Tell us something about this download... </textarea><br>
